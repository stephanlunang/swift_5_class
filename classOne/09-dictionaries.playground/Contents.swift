...
animalDict["Lions"] = "Rawr"
animalDict["Tigers"] = "Roar"
animalDict["Bears"] = "AWR"
animalDict["Humans"] = "Oh my!"

for (name, description) in animalDict {
    print("Animal: \(name) -- Description: \(description)")
}

animalDict = [:]

animalDict["CA"] = "California"
animalDict["NV"] = "Nevada"
animalDict["OR"] = "Oregon"

for (abbrev, full) in animalDict {
    print("\(full): \(abbrev)")
}

animalDict["CA"] = nil

for key in animalDict.keys {
    print(key)
}
