...
var purchases: [Double] = [10.45, 11.13, 131.21, 11.11, 10.00, 1.31, 1231.23, 10.31, 17.31, 1662.10]
for purchase in purchases {
    print("Purchase: \(purchase)")
}

for x in 0..<purchases.count {
    purchases[x] += 0.10
    print("New Price: \(purchases[x])")
}

for x in (0..<purchases.count).reversed() {
    print("Reverse Purchase: \(purchases[x])")
}
