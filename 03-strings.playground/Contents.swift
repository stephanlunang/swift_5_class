 ...
 */
let dateOfBirth: String = "08/15/1992"
var ageOfMe: Int = 27
let isOrganDonor: Bool = true
let nameOfMe: String = "Stephan"
print("Hello, my name is \(nameOfMe), my age is \(ageOfMe), I was born on \(dateOfBirth) and it is \(isOrganDonor) that I am an organ donor")
